...
* telefono:phone varchar(30) nn df'Sin telefono'
* correo electronico: email varchar(200) nn
* contraseña: pass varchar(300) nn
* nombre de usuario: name varchar(16) nn
* edad: age int nn
...
alter table users
    add constraint fk_users_contr_id
